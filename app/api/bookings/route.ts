...
export async function POST(req: NextRequest) {
  try {
    ...
    try {
      ...
      const customerEmailSubject = `TradersTap Booking Confirmation - ${serviceName}`;
      const customerEmailContent = `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; color: #000;">
          ...
          <p style="color: #000;">Thank you for choosing TradersTap!</p>
          
          <hr style="border: none; border-top: 1px solid #ddd; margin: 30px 0;">
          <p style="color: #666; font-size: 12px;">This is an automated message from TradersTap. Please do not reply to this email.</p>
        </div>
      `;
      ...
      if (providerName && providerName !== 'Unknown Provider') {
        const providerEmailSubject = `New TradersTap Booking - ${serviceName}`;
        const providerEmailContent = `
          <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; color: #000;">
            ...
            <p style="color: #000;">You have received a new service booking through TradersTap:</p>
            ...
            <p style="color: #000;">Thank you for being part of the TradersTap network!</p>
